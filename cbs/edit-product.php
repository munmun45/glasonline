                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <?php if (!empty($product['image_url'])): ?>
                                            <img id="imagePreview" src="../<?php echo htmlspecialchars($product['image_url']); ?>" 
                                                 alt="Current Image" class="img-thumbnail preview-image mt-2">
                                        <?php else: ?>
                                            <img id="imagePreview" src="#" alt="Preview" class="img-thumbnail preview-image mt-2" style="display: none;">
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
